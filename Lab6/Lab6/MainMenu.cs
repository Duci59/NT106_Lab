...
namespace Lab6
{
    public partial class MainMenu : Form
    {
        ...
        private MainPlay serverForm = null;
        ...
        private void btnClient_Click(object sender, EventArgs e)
        {
            ...
            serverForm = new MainPlay(this, joinUsername.Text, joinIP.Text, joinPort.Text, time);
            serverForm.Show();
        ...
        private void roundStart()
        {
            ...
            if (round == 0)
            {
                round = rand.Next(5, 7); //Tối thiểu 5 round
